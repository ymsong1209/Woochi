...
public class E_ScrollDog : BaseElite
{
    ...
    {
        base.Initialize();
        GameObject instantiatedCritBuffGameObject = Instantiate(critBuff.gameObject, transform);
        ScrollDogIncreaseCritBuff instantiatedcritBuff = instantiatedCritBuffGameObject.GetComponent<ScrollDogIncreaseCritBuff>();
        ApplyBuff(this,this,instantiatedcritBuff);
    }
